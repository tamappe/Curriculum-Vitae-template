...
メインタスクは社内のモバイルSDKの保守・運用になります。  
タスクの内容をカテゴリー分けすると次のようになります。

1. iOS SDKのメンテナンス
2. Android SDKのメンテナンス
3. OSやライブラリのアップデート作業
4. チームビルディングの改善
...
iOSであればOSのバージョンアップに伴うソースコードの修正。  
AndroidであればtargetSDKVersionなどのbuild.gradleに関する修正対応。  

##### 4. チームビルディングの改善

- 開発メンバーのスキル向上への貢献
- アジャイル開発の導入
- リリース作業などの継続的開発に必要なドキュメント整備
